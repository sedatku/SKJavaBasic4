...
public class WrapperClasses {
	public static void main(String[] args) {
		...
		Integer number2 = 3500; //auto-boxing: converting from primitive to Object automatically
		int num26 = number2; //auto-unboxing: converting from object to primitive automatically
		...
		System.out.println("---Other Wrapper Class---");
